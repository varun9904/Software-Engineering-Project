...
<?php if(isset($_POST['search'])){
  ...
  $bg=$_POST['blood'];
  if ($bg == 7) {
    $sql = "select * from donor_details join blood on donor_details.donor_blood = blood.blood_id order by rand() limit 5";
  } 
  else {
      $sql = "select * from donor_details join blood on donor_details.donor_blood = blood.blood_id AND donor_blood='{$bg}' order by rand() limit 5";
  }
